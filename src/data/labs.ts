...
export const FORGE_LABS: ForgeLab[] = [
  ...
  },
  {
    ...
    hook: 'Parse a genuine Parquet footer and read a column chunk — projection means touching only the chunks you asked for, and malformed input means refusing rather than guessing.',
    trackId: 'c3',
    lessonId: 'c3.l2',
    minutes: 80,
    ...
    checks: [
      { id: 'footer_parse', label: 'magic, footer length and schema parsed from a real fixture' },
    ...
    brief: [
      'Every lab so far let you choose your own layout. This one makes you read someone else\'s, because that is the actual job: Parquet is the interchange format, and a platform that cannot read it is not part of the ecosystem. The structure is four levels — file, row group, column chunk, page — and the footer at the end of the file describes all of them, which is why a reader seeks to the end first.',
